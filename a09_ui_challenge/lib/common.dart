...
var sampleContentList = [
  {
    ...
    "content": "This weekend spectacular event will celebrate dogs everwhere in a large-scale ... "
  },
  {
    "dayOfWeek": "Thu",
    "day": "19",
...
class Calendar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration:
          const BoxDecoration(color: Color(primaryBlueColor), borderRadius: BorderRadius.all(Radius.circular(9))),
      width: 50,
      height: 60,
      child: const Column(
