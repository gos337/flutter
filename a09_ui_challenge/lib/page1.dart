...
class _Page1State extends State<Page1> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    slideRightAnimation = Tween<Offset>(begin: Offset.zero, end: const Offset(1.0, 0.0))
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async {
            ...
            if (mounted) {
              Navigator.push(context, _createRoute()).then((value) => controller.reset());
            }
          },
          child: const Icon(
            Icons.search,
      ...
      body: Column(
        children: [
          ...
          SlideTransition(position: slideRightAnimation, child: const HeaderList()),
          const SizedBox(height: 20),
          SlideTransition(position: slideRightAnimation, child: const MainBody()),
        ],
      ),
    );
  }
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Text("Tea Ceremony", style: TextStyle(fontWeight: FontWeight.bold)),
                      SizedBox(
                        height: 10,
                      ),
...
class HeaderList extends StatelessWidget {
  ...
  final List headers = const <String>["Popular", "Features", "Trending", "Recent"];
