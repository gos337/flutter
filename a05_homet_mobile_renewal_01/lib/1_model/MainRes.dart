...
enum DesignType { Banner, FavTheme, TrainerTheme, BannerTheme, PartTrainingTheme }
...
Map<DesignType, String> designTypeValues = {
  ...
  DesignType.PartTrainingTheme: "DT007",
};
...
class MainRes {
  ...
  ///    함수 part              /
  ///                          /
  int GetFavThemeItemCount(DesignType designType) {
    int? index = GetIndexOfDesigntype(designType: designType);
