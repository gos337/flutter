...
AuthTokenRes authTokenResFromJson(String str) => AuthTokenRes.fromJson(json.decode(str));
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        membershipName:
            json["membership_name"] == null ? null : List<String>.from(json["membership_name"].map((x) => x)),
...
class UserInfo {
  ...
  factory UserInfo.fromJson(Map<String, dynamic> json) => UserInfo(
        ...
        freeTrialInfo: json["free_trial_info"] == null ? null : FreeTrialInfo.fromJson(json["free_trial_info"]),
      );
